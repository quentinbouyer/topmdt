...
void compte_nid()
{
        ...
        {
                fprintf (stderr, "Impossible d'ouvrir le répertoire /proc/fs/lustre/mdt");
                exit ( EXIT_FAILURE );
        }
}
